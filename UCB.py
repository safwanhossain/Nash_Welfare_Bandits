...
class UCB:
    ...
    def run_sim(self, tup,t):
        ...
        #best_p_1 = solve_cvx_ucb(empirical_rewards, num_samples,self.k, self.n, t)
        #print("Torch", best_p)
        #print("NSW TORCH", self.bandit_instance.get_nsw(best_p))
        #print("CVX UCB",best_p_1)
        #print("NSW CVX", self.bandit_instance.get_nsw(best_p_1))
    ...
    def run(self):
        ...
        for t in tqdm(range(self.k, self.T)):
            ...
            for future in futures:
                ...
                #print(t, "Curr P", best_p, " regret: ", regret)
